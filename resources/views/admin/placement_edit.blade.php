...
<div class="content-wrapper">
   ...
   @endif
      ...
      <form action="{{url('admin/placement_update')}}" method="post" enctype="multipart/form-data">
          @csrf
       ...
       <h2><label class="lead">Name</label></h2>
        ...
        name="placement_image" value="{{$edit->placement_image}}">

        <img src="{{ url('/placement/'.$edit->placement_image) }}" style="height: 110px; width: 110px; border-radius: 100%;"></td>
        <br><br>
        <input type="submit" class="btn btn-info" name="placement_update" value="placement_update" style="float: right;">
     </form>
     </div><!-- card header -->
   </div><!-- card -->
 </div><!-- col-md-12 -->
